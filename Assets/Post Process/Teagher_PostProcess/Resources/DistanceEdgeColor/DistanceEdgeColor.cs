...
{
    [Serializable]
    [PostProcess(typeof(DistanceEdgeColorRenderer), PostProcessEvent.AfterStack, "Raivk/DistanceEdgeColor")]
    public sealed class DistanceEdgeColor : PostProcessEffectSettings
    {
        [Range(0f, 1f)]
    ...
    public sealed class DistanceEdgeColorRenderer : PostProcessEffectRenderer<DistanceEdgeColor>
    {
        public override void Render(PostProcessRenderContext context)
        {
            var sheet = context.propertySheets.Get(Shader.Find("Raivk/DistanceEdgeColor"));
